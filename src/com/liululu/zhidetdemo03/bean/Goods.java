...
public class Goods {
	...
	public void setPrdStatus(int prdStatus) {
		if (prdStatus == 1) {
			this.prdStatus = com.liululu.zhidetdemo03.R.drawable.status_hot_sale;
		} else if (prdStatus == 5) {
			this.prdStatus = com.liululu.zhidetdemo03.R.drawable.status_first;
		} else if (prdStatus == 2) {
			this.prdStatus = com.liululu.zhidetdemo03.R.drawable.status_new;
		} else {
			this.prdStatus = -1;
		}
	}
	...
	public void setPrdUnitPrice(String prdUnitPrice) {
		this.prdUnitPrice = "гд" + prdUnitPrice;
	}
